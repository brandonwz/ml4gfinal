...
def load_saved_model(checkpoint_name, model):
	checkpt = "./checkpoints/" + checkpoint_name
...
if __name__ == '__main__':
	...
	if(os.path.exists(TRIAL_DIR) == False):
		print("Error: trial does not exist.")
		sys.exit()
	...
	for cell_pair in cell_pairs:
		...
		hmnet = load_saved_model(TRIAL_SAVE, hmnet)
